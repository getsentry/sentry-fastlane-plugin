...
- Bump CLI from v2.36.3 to v2.38.2 ([#280](https://github.com/getsentry/sentry-fastlane-plugin/pull/280))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2382)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.36.3...2.38.2)
