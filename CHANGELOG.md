...
- Bump CLI from v2.36.3 to v2.36.6 ([#274](https://github.com/getsentry/sentry-fastlane-plugin/pull/274))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2366)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.36.3...2.36.6)
