...
- Bump CLI from v2.36.3 to v2.36.5 ([#273](https://github.com/getsentry/sentry-fastlane-plugin/pull/273))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2365)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.36.3...2.36.5)
