...
- Bump CLI from v2.36.3 to v2.39.0 ([#282](https://github.com/getsentry/sentry-fastlane-plugin/pull/282))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2390)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.36.3...2.39.0)
